                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('admin.attributes.index') }}" class="btn btn-success shadow-sm float-right"> <i
                                                ...
                                                <div class="col-sm-10">
                                                    <select class="form-control" name="validation" id="validation">
                                                        @foreach ($validations as $validation)
                                                            <option
                                                                {{ old('validation') == $validation ? 'selected' : null }}
                                ...
                                <fieldset class="form-group">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group row border-bottom pb-4">
                                                <label for="is_filterable" class="col-sm-2 col-form-label">Filter Product
                                                    ?</label>
                                                <div class="col-sm-10">
