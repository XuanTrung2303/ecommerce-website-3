                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('admin.attributes.attribute_options.create', $attribute) }}"
                                class="btn btn-success shadow-sm float-right"> <i class="fa fa-plus"></i> Add</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group btn-group-sm">
                                                        <a href="{{ route('admin.attributes.attribute_options.edit', [$attribute, $attribute_option]) }}"
                                                            class="btn btn-sm btn-primary">
                                                            <i class="fa fa-edit"></i>
                                                        </a>
                                                        <form onclick="return confirm('are you sure !')"
                                                            action="{{ route('admin.attributes.attribute_options.destroy', [$attribute, $attribute_option]) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('admin.attributes.index') }}" class="btn btn-success shadow-sm float-right">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('admin.attributes.update', $attribute) }}">
                                            ...
                                            <div class="form-group row border-bottom pb-4">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="code"
                                                        value="{{ old('code', $attribute->code) }}" id="code">
                                                </div>
                                            </div>
                                            <div class="form-group row border-bottom pb-4">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="name"
                                                        value="{{ old('name', $attribute->name) }}" id="name">
                                                </div>
                                            </div>
                                            <div class="form-group row border-bottom pb-4">
                                ...
                                <fieldset class="form-group">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <legend class="col-form-label pt-0 text-green">Validation</legend>
                                            <div class="form-group row border-bottom pb-4">
                                                <label for="is_required" class="col-sm-2 col-form-label">Must be filled
                                                    ?</label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group row border-bottom pb-4">
                                                ...
                                                <div class="col-sm-10">
                                                    <select class="form-control" name="is_unique" id="is_unique">
                                                        @foreach ($booleanOptions as $no => $booleanOption)
                                                            <option
                                                                {{ old('is_unique', $attribute->is_unique) == $no ? 'selected' : null }}
                                                                value="{{ $no }}">{{ $booleanOption }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group row border-bottom pb-4">
                                                <label for="validation" class="col-sm-2 col-form-label">Validation</label>
                                                <div class="col-sm-10">
                                ...
                                <fieldset class="form-group">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <legend class="col-form-label pt-0 text-green">Configuration</legend>
                                            <div class="form-group row border-bottom pb-4">
                                                <label for="is_configurable" class="col-sm-2 col-form-label">Configuration
                                                    Produk ?</label>
                                                <div class="col-sm-10">
                                                    <select class="form-control" name="is_configurable"
                                                        id="is_configurable">
                                                        @foreach ($booleanOptions as $no => $booleanOption)
                                                            <option
                                            ...
                                            <div class="form-group row border-bottom pb-4">
                                                ...
                                                <div class="col-sm-10">
                                                    <select class="form-control" name="is_filterable" id="is_filterable">
                                                        @foreach ($booleanOptions as $no => $booleanOption)
                                                            <option
                                                                {{ old('is_configurable', $attribute->is_filterable) == $no ? 'selected' : null }}
                                                                value="{{ $no }}">{{ $booleanOption }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
