                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.shipments.update', $shipment) }}" method="POST">
                            ...
                            <div class="form-group">
                                <label for="track_number">Receipt Number</label>
                            ...
                            <div class="col-lg-5 col-xl-6 col-xl-3 ml-sm-auto">
                                <ul class="list-unstyled mt-4">
                                    <li class="mid pb-3 text-dark">Subtotal
                                        <span
                                            class="d-inline-block float-right text-default">{{ $shipment->order->base_total_price }}</span>
                                    </li>
                                    <li class="mid pb-3 text-dark">Tax(10%)
                                        <span
                                            class="d-inline-block float-right text-default">{{ $shipment->order->tax_amount }}</span>
                                    </li>
                                    <li class="mid pb-3 text-dark">Shipping Cost
                                        <span
                                            class="d-inline-block float-right text-default">{{ $shipment->order->shipping_cost }}</span>
                                    </li>
