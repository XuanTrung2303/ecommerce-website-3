                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('admin.slides.index') }}" class="btn btn-success shadow-sm float-right"> <i
                                ...
                                <div class="form-group row border-bottom pb-4">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="title"
                                            value="{{ old('title', $slide->title) }}" id="title">
                                    </div>
                                </div>
                                <div class="form-group row border-bottom pb-4">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="url"
                                            value="{{ old('url', $slide->url) }}" id="url">
                                    </div>
                                </div>
                                <div class="form-group row border-bottom pb-4">
                                    <label for="path" class="col-sm-2 col-form-label">Image</label>
                                    <div class="col-sm-10">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" name="status" id="status">
                                            @foreach ($statuses as $value => $status)
                                                <option {{ old('status', $slide->status) == $value ? 'selected' : null }}
